...
@Component({
  selector: 'app-edit-unidadbasica',
   imports: [ReactiveFormsModule], 
  templateUrl: './edit-basica.html',
  styleUrl: './edit-basica.css',
})
export class Editbasica implements OnInit{
...
private RegisterNew(datos :BasicModel) {
    ...
    this.unidadbasicaService.register(datos)
           .subscribe({
              ...
              console.log('Success payload:', data);
                if (data.error) {
                  ...
                  this.router.navigate(['/listadoUnidadbasicas']);
                }
...
private Update(datos :BasicModel) {
    ...
    this.unidadbasicaService.update(datos)
           .subscribe({
              next: (data: ResponseData) => {
                this.isLoading = false;
              console.log('Success payload:', data);
...
async safeCall(id: string) {
      ...
      this.unidadbasicaService.getunidadbasica(id).subscribe({
        next: (data) => {
        ...
        error: (err) => {
          console.error("Error reading unidadbasicas");
        }
