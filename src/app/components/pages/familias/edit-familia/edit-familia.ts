...
@Component({
  ...
  templateUrl: './edit-familia.html',
  styleUrl: './edit-familia.css',
})
export class EditFamilia implements OnInit{
...
private RegisterNew(datos :BasicModel) {
    ...
    this.familiaService.register(datos)
           .subscribe({
              ...
              console.log('Success payload:', data);
                if (data.error) {
                  ...
                  this.router.navigate(['//listadoFamilias']);
                }
...
private Update(datos :BasicModel) {
    ...
    this.familiaService.update(datos)
           .subscribe({
              next: (data: ResponseData) => {
                this.isLoading = false;
              console.log('Success payload:', data);
...
async safeCall(id: string) {
      ...
      this.familiaService.getfamilia(id).subscribe({
        next: (data) => {
        ...
        error: (err) => {
          console.error("Error reading familias");
        }
